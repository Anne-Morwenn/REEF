...
! Writing controlling parameters for the final figure
      ...
      write(12,'(a, f4.1, a)') '1 20 Eroded volume = ', V0, 'mm3/y'
...
!            if (Superf(i)>1) then
!                  write(98,*) t(i), Superf(i)
!                  write(99,*) t(i), Crois(i)
!            else
!                  write(98,*) t(i), '0'
!                  write(99,*) t(i), '0'
!            endif
...
!      close(96)
      ...
      deallocate(x, y, xold, yold, xoldd, yoldd, Vol)
!      deallocate(Volreef, Superf, Crois)
